...
png(file=path_figs&'\\DebrisFreezing.png', res = 160,width=2400,height=800)
par(mfcol=c(1,1), mar=c(4,5,1,2), oma=c(0,0,0,0),cex.axis = 1.5,cex.lab = 1.5)
plot(ECprofile1$DateTime[5200:6300],ECprofile1$surf1[5200:6300,2],type='l',lwd = 2,ylim=c(-7,12),xlab = 'Date', ylab = expression('T'['debris']~~'[°C]'),col=cols[1])
points(ECprofile1$DateTime[5200:6300],ECprofile1$surf2[5200:6300,2],col=cols[2],type='l',lty = 1,lwd = 4)
points(ECprofile1$DateTime[5200:6300],ECprofile1$surf3[5200:6300,2],col=cols[3],type='l',lty = 1,lwd = 4)
points(ECprofile1$DateTime[5200:6300],ECprofile1$surf4[5200:6300,2]*10,col=cols[4],type='l',lty = 2,lwd = 3)
abline(h=seq(-10,20,1),v=seq(ECprofile1$DateTime[5000], ECprofile1$DateTime[6500], by = "day"), col="gray", lty=3)
#abline(v=c(ECprofile1$DateTime[5465],ECprofile1$DateTime[5465]), col="black", lwd=2,lty=3)
#abline(v=c(ECprofile1$DateTime[5680],ECprofile1$DateTime[5740]), col="black", lwd=2,lty=3)
#abline(v=c(ECprofile1$DateTime[5880],ECprofile1$DateTime[6120]), col="black", lwd=2,lty=3)
rect(ECprofile1$DateTime[5465], -4, ECprofile1$DateTime[5530], 5, density = NULL, angle = 45,
     col = NA, border = NULL, lty = 3, lwd = 2)
legend('bottomright',legend = c('surface','0.25 m','0.45 m','0.65 m (ice, x10)'),cex= 1.5,bty = 'n',lty=c(1,1,1,2),lwd = c(1,3,3,2),col=cols)
dev.off()


par(mfcol=c(1,1), mar=c(4,5,1,2), oma=c(0,0,0,0),cex.axis = 1.5,cex.lab = 1.5)
plot(ECprofile1$DateTime[2300:3400],ECprofile1$surf1[2300:3400,2],type='l',lwd = 2,ylim=c(-7,12),xlab = 'Date', ylab = expression('T'['debris']~~'[°C]'),col=cols[1])
points(ECprofile1$DateTime[2300:3400],ECprofile1$surf2[2300:3400,2],col=cols[2],type='l',lty = 1,lwd = 4)
points(ECprofile1$DateTime[2300:3400],ECprofile1$surf3[2300:3400,2],col=cols[3],type='l',lty = 1,lwd = 4)
points(ECprofile1$DateTime[2300:3400],ECprofile1$surf4[2300:3400,2]*10,col=cols[4],type='l',lty = 2,lwd = 3)
abline(h=seq(-10,20,1),v=seq(ECprofile1$DateTime[2300], ECprofile1$DateTime[3400], by = "day"), col="gray", lty=3)
#abline(v=c(ECprofile1$DateTime[5465],ECprofile1$DateTime[5465]), col="black", lwd=2,lty=3)
#abline(v=c(ECprofile1$DateTime[5680],ECprofile1$DateTime[5740]), col="black", lwd=2,lty=3)
#abline(v=c(ECprofile1$DateTime[5880],ECprofile1$DateTime[6120]), col="black", lwd=2,lty=3)
rect(ECprofile1$DateTime[5465], -4, ECprofile1$DateTime[5530], 5, density = NULL, angle = 45,
...
png(file=path_figs&'\\DebrisTempProfile1.png', res = 160,width=1800,height=600)
par(mfcol=c(1,3), mar=c(4,5,1,2), oma=c(0,0,0,0),cex.axis = 1.5,cex.lab = 1.5)
...
grid(NULL,NULL)
plot(diuProf1$surf1_dry[,2],type='l',col='black',ylim = c(-2,16),xlab = 'Time [h]',ylab = expression('T'['debris']~~'[°C]'),lwd = 2)
...
points(diuProf1$surf1_cold[,2],type='l',col='blue',ylim = c(-5,10),xlab = 'Time [h]',ylab = expression('T'['debris']~~'[°C]'),lwd = 2)
points(diuProf1$surf2_cold[,2],type='l',col='blue',lwd = 2,lty = 2)
points(diuProf1$surf3_cold[,2],type='l',col='blue',lwd = 2,lty = 3)
points(diuProf1$surf4_cold[,2],type='l',col='blue',lwd = 2,lty= 4)
...
grid(NULL,NULL)
plot(diuProf1$surf1_wet[,2],type='l',col='red',ylim = c(-2,16),xlab = 'Time [h]',ylab = expression('T'['debris']~~'[°C]'),lwd = 2)
...
grid(NULL,NULL)
matplot(t(Tdry_profile),rev(d_ECprofile/100),ylim = rev(range(d_ECprofile/100)),lwd=2,type='o',pch = 1:6,xlim=c(-2,17),lty=c(1,2,3,4,5,6),col='black',cex =  1.5,ylab = 'Depth [m]',xlab = expression('T'['debris']~~'[°C]'))
matplot(t(Twet_profile),rev(d_ECprofile/100),type='o',pch = 1:6,xlim=c(-2,17),lwd=2,lty=c(1,2,3,4,5,6),col='red',add=T,cex=2)
matplot(t(Tcold_profile),rev(d_ECprofile/100),type='o',pch = 1:6,xlim=c(-2,17),lwd=2,lty=c(1,2,3,4,5,6),col='blue',add=T,cex=2)
grid(NULL,NULL)
...
png(file=path_figs&'\\DebrisTempProfile2012.png', res = 160,width=1800,height=600)
par(mfcol=c(1,3), mar=c(4,5,1,2), oma=c(0,0,0,0),cex.axis = 1.5,cex.lab = 1.5)
#layout(matrix(c(1,3), nrow = 1, ncol = 3, byrow = TRUE))
...
grid(NULL,NULL)
matplot(t(Tdry_profile_2012),rev(d_2012), ylim = rev(range(d_2012)),lwd=2,type='o',pch = 1:6,xlim=c(-2,17),lty=c(1,2,3,4,5,6),col='black',cex =  1.5,ylab = 'Depth [m]',xlab = expression('T'['debris']~~'[°C]'))
matplot(t(Twet_profile_2012),rev(d_2012),type='o',pch = 1:6,xlim=c(-2,17),lwd=2,lty=c(1,2,3,4,5,6),col='red',add=T,cex=2)
legend('bottomright',legend = c('00:00','04:00','08:00','12:00','16:00','20:00'),cex=  1.2,bty = 'n',lty=c(1,2,3,4,5,6))
grid(NULL,NULL)
dev.off()

png(file=path_figs&'\\DebrisTempProfile2013.png', res = 160,width=1800,height=600)
par(mfcol=c(1,3), mar=c(4,5,1,2), oma=c(0,0,0,0),cex.axis = 1.5,cex.lab = 1.5)
#layout(matrix(c(1,3), nrow = 1, ncol = 3, byrow = TRUE))
plot(diuProfETH2013$surf1_dry[,2],type='l',col='black',ylim = c(0,21),xlab = 'Time [h]',ylab = expression('T'['debris']~~'[°C]'),lwd = 2)
...
legend('topleft',legend = c('surface','0.02 m','0.04 m','0.06 m','0.1 m','0.3 m','0.45 m'),cex= 1.2,bty = 'n',lty=c(1,2,3,4,5,6,7),lwd = 2)
grid(NULL,NULL)
plot(diuProfETH2013$surf1_wet[,2],type='l',col='red',ylim = c(0,21),xlab = 'Time [h]',ylab = expression('T'['debris']~~'[°C]'),lwd = 2)
...
matplot(t(Tdry_profile_2013),d_2013, ylim = rev(range(d_2013)),type='o',lwd=2,pch = 1:6,xlim=c(-2,17),lty=c(1,2,3,4,5,6),col='black',cex =  1.5,ylab = 'Depth [m]',xlab = expression('T'['debris']~~'[°C]'))
matplot(t(Twet_profile_2013),d_2013,type='o',pch = 1:6,xlim=c(-2,17),lwd=2,lty=c(1,2,3,4,5,6),col='red',add=T,cex=2)
legend('bottomright',legend = c('00:00','04:00','08:00','12:00','16:00','20:00'),cex=  1.5,bty = 'n',lty=c(1,2,3,4,5,6))
grid(NULL,NULL)
dev.off()
...
plot(DebrisDataelse$volumetric.soil.moisture..m3.m3.,as.numeric(DebrisDataelse$measured.Depth)/as.numeric(DebrisDataelse$Total.Depth),ylim = rev(range(as.numeric(DebrisDataelse$measured.Depth)/as.numeric(DebrisDataelse$Total.Depth),na.rm=T)),xlab = expression('soil moisture ['~m^{3}~''~ m^{-3} ~']'),ylab = expression('relative depth [-]'),pch=25, bg="blue",col='red')
grid(NULL,NULL)
dev.off()
...
par(mfcol=c(1,1), mar=c(4,5,1,2), oma=c(0,0,0,0),cex.axis = 1,cex.lab = 1)
boxplot(cbind(cond_tot_distrib,cond_tot_wet,cond_tot_dry),names=c('mix','wet','dry'),ylab = expression('thermal conductivity [J '~m^{-1}~''~ K^{-1} ~']'),col=c('white'))
